...
module.exports = (client, data, callback) => {
  ...
  let {
    ...
    messageStartFrequency,
    messageIncrementFrequencyBy,
    messageIncrementInterval,
  ...
  messageFrequency = parseInt(messageStartFrequency);
  messageInterval = 1000 / messageFrequency;
  messageIncrementFrequencyBy = parseInt(messageIncrementFrequencyBy);
  ...
  function incrementSendInterval() {
    ...
    messageFrequency += messageIncrementFrequencyBy;
    messageInterval = 1000 / messageFrequency;
